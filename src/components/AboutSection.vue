  ...
  <section id="about" class="py-24 overflow-hidden bg-hero-pattern" style="background-color: #FDFAF4">
    <div class="max-w-6xl mx-auto px-6">
      ...
      <div class="relative">
        ...
        <div v-for="(event, i) in timeline" :key="i" :data-aos="i % 2 === 0 ? 'fade-right' : 'fade-left'"
          :data-aos-delay="i * 100" class="relative flex md:items-center mb-10 md:mb-16"
          ...
          <!-- Dot -->
          <div
            class="absolute left-1/2 -translate-x-1/2 hidden md:flex items-center justify-center w-10 h-10 rounded-full shadow"
...
const timeline = [
  ...
  },
  {
    year: '2024 · 春',
    title: '蜜月旅行',
    desc: '疫情後宗毅和怡雯第一次一起出國旅行，兩人一起出國去日本渡蜜月，體驗了當地生活。\ne.g.凌晨跟清水寺的阿公阿嬤一起跳早操😂\n不論是美食、文化還是風景都留下了美好的回憶，也仗著蜜月在各個景點收到很多祝福跟贈品。\n之後也讓我們更期待未來一起探索世界的日子！',
    icon: StarIcon,
    photos: [],
  },
  {
    year: '2027 · 春',
    title: '永結同心',
    desc: '從認識到交往再到結婚也已經10年了！\n雖然兩人各有固執的地方，接下來也會繼續相互扶持、一起成長，迎接人生的下一個階段！',
    icon: SparklesIcon,
    photos: [],
  },
]
